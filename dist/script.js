...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  function showTabContent() {
    var indexElem = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
  ...
  header.addEventListener('click', function (event) {
    var target = event.target;
    var condition = target.classList.contains(tabSelector.replace(/\./, "")) || target.parentNode.classList.contains(tabSelector.replace(/\./, ""));
